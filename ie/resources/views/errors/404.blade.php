<style>
    @font-face {
        font-family: "iran";
        src: url('http://commercial.ie/fonts/IranianSans.ttf');
        font-weight: normal;
        font-style: normal;
    }
    ...
    @font-face {
        font-family: "2Titr";
        src: url('http://commercial.ie/fonts/2Titr.ttf');
        font-weight: normal;
        font-style: normal;
    }
    body {
...
<div class="not-found parallax">
    ...
    <div class="wave-message">
        <p style="font-family: 'iran', serif !important; font-size: 60%">صفحه مورد نظر یافت نشد</p>
        <a href="{{route('login')}}" style="font-size: 70%;font-family: 'iran', serif; color: #f2ffa4; text-decoration: none">
            <p>برای بازگشت به صفحه اصلی اینجا کلیک کنید</p></a>
    </div>
    <script>
